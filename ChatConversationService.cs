...
public sealed class ChatConversationService : IChatConversationService
{
    ...
    private string AgentId
    {
        get { return _agentIdentityProvider.GetAgentId(); }
                ...
                _sessionBootstrapper = new ConversationSessionBootstrapper(agentFactory, settings, agentIdentityProvider, sqlChatHistoryProvider);
                _historyLoader = new ConversationHistoryLoader(sqlChatHistoryProvider);
    /// <summary>
