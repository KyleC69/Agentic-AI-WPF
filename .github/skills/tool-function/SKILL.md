...
### • A matching **PowerShellExecutor skill file**  
### • A **WindowsDiagnostics skill file** for your consolidated tools  
### • A **PathResolver skill file**  
### • A **ToolResult<T> contract file**  
### • A **ToolFunctions manifest** that enumerates all tools  
