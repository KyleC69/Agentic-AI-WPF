...
public class AIChatHistoryDb : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ModelBuilder unused20 = modelBuilder.Entity<ChatHistoryMessage>(entity =>
        {
            ...
            var unused17 = entity.HasIndex(e => new { e.ConversationId, e.CreatedAt }, "IX_ChatHistoryMessages_Conversation_CreatedAt");
        ...
        ModelBuilder unused7 = modelBuilder.Entity<ChatHistoryTextChunk>(entity =>
        {
            ...
            var unused2 = entity.Property(e => e.CreatedAt).HasDefaultValueSql("(datetime())", "DF__tmp_ms_xx__Creat__2FCF1A8A");
