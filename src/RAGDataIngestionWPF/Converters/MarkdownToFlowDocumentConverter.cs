...
/// <summary>
/// Converts chat message text into a formatted <see cref="FlowDocument" /> so markdown output is rendered consistently in the UI.
/// </summary>
public sealed class MarkdownToFlowDocumentConverter : IValueConverter
{
    /// <summary>
    /// Converts a chat message string into a markdown-rendered <see cref="FlowDocument" /> for display in the chat transcript.
    /// </summary>
